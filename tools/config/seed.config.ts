...
export class SeedConfig {
  ...
  protected SYSTEM_CONFIG_DEV: any = {
    ...
    paths: {
      ...
      '@angular/core': `${this.NPM_BASE}@angular/core/index.js`,
      '@angular/common': `${this.NPM_BASE}@angular/common/index.js`,
      '@angular/compiler': `${this.NPM_BASE}@angular/compiler/index.js`,
      '@angular/forms': `${this.NPM_BASE}@angular/forms/index.js`,
      '@angular/http': `${this.NPM_BASE}@angular/http/index.js`,
      '@angular/router': `${this.NPM_BASE}@angular/router/index.js`,
      '@angular/platform-browser': `${this.NPM_BASE}@angular/platform-browser/index.js`,
      '@angular/platform-browser-dynamic': `${this.NPM_BASE}@angular/platform-browser-dynamic/index.js`,
